...
//-------------------------------------------------------------------------------
- (void)initController {
    maIntroTitles   = [[NSMutableArray alloc] initWithObjects: @"Sigue a tu equipo favorito", @"De la liga MX", @"Y demuestra tu pasión", nil];
    
    maIntroImgs     = [[NSMutableArray alloc] initWithObjects: @"equipos.jpg", @"LigaMX.jpg", @"barra.jpg", nil];
